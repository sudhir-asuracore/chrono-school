...
func (r *RoomRepo) List(ctx context.Context, orgID uuid.UUID) ([]models.Room, error) {
	...
	query := `SELECT * FROM rooms WHERE organization_id = $1 ORDER BY id`
