...
const AdminPage: React.FC = () => {
  ...
  const handleClearData = async () => {
    if (!clearOptions.teachers && !clearOptions.subjects && !clearOptions.classes && !clearOptions.rooms && !clearOptions.levels) {
    ...
    try {
      ...
      setClearOptions({ teachers: false, subjects: false, classes: false, rooms: false, levels: false });
    } catch (err: any) {
    ...
    <div className="space-y-12">
      ...
      <div className="bg-white/50 backdrop-blur-md p-10 rounded-[2.5rem] shadow-sm border border-white">
        <div className="flex items-center justify-between mb-8">
          ...
          <button
            onClick={() => {
              const allSelected = clearOptions.teachers && clearOptions.subjects && clearOptions.classes && clearOptions.rooms && clearOptions.levels;
              setClearOptions({
          ...
          >
            {clearOptions.teachers && clearOptions.subjects && clearOptions.classes && clearOptions.rooms && clearOptions.levels ? 'Deselect All' : 'Select All'}
          </button>
        </div>
        ...
        <button
          ...
          disabled={!clearOptions.teachers && !clearOptions.subjects && !clearOptions.classes && !clearOptions.rooms && !clearOptions.levels}
