...
func (r *SubjectRepo) List(ctx context.Context, orgID uuid.UUID) ([]models.Subject, error) {
	...
	query := `SELECT * FROM subjects WHERE organization_id = ? ORDER BY id`
